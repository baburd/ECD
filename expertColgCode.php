...
//include("clgCode.php");
$colgCode=$_POST['exprname'];

 	if(strlen($colgCode)<2)
		{echo '<script type="text/javascript">alert("Please Specify all field values")</script>'; die('');}
	else
	{
  $sql="select a.subjCode,b.subjName,b.subjYrSem,a.expertID,c.expertName,c.expertAff,a.isActive,a.effectiveYear,a.yearFor,c.expertExp from expertSubj as a, subjectList as b, expertList as c where
(a.subjCode=b.subjCode and a.expertID=c.expertID and c.expertAff ='".trim($colgCode)."')";
  //$params = array("%$colgCode%");
