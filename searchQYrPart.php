...
$lbl = $_POST['lbl'];
	...
	{
  $sql="select * from appointQExpert where effYearSem='".$lbl."' and pYrSem like ?";
  ...
  $stmt->execute($params);
	...
	while ($row = $stmt->fetch()) 
	{
		...
		echo '<td Align="Center">'.$refNo.'<td Align="Center">'.$expertID.'</td><td Align="Center">'. $expertName .'</td><td Align="Center" >'.$pCode.'</td><td Align="Center">'.$pName.'</td><td Align="Center">'.$pYrSem.'</td><td Align="Center">'.$subjName.'</td><td Align="Center">'.$collegeName.'</td><td Align="Center">'.$qTotal.'</td><td Align="Center">'.$effYearSem.'</td><td Align="Center">'.$status.'</td></tr>';
